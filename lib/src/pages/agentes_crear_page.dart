...
class AgentesCrearPage extends StatefulWidget {
  @override
  createState() => _AgentesCrearPage();
}

class _AgentesCrearPage extends State<AgentesCrearPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text('Agregar agente'), backgroundColor: Colors.blueGrey),
      body: Form(
