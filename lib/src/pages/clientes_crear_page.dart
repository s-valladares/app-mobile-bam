...
class ClientesCrearPage extends StatefulWidget {
  @override
  createState() => _ClientesCrearPage();
}

class _ClientesCrearPage extends State<ClientesCrearPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text('Agregar cliente'), backgroundColor: Colors.blueGrey),
      body: Form(
